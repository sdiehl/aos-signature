...
1. Compute h by encoding the hash of the public keys to a point in the curve, while hiding its discrete logarithm, and y = [x<sub>k</sub>] \* h. Both computations are the product of a scalar and a point in the curve.
